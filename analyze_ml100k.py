...
print("All mean,  RMSE: %.2f" % (rechelper.metrics.rmse(y_true, y_all_mean)))
print("Item mean, RMSE: %.2f" % (rechelper.metrics.rmse(y_true, y_item_mean)))
print("User mean, RMSE: %.2f" % (rechelper.metrics.rmse(y_true, y_user_mean)))